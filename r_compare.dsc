...
DSC:
  ...
  run:
    default: data * sim_gaussian * get_sumstats * ((susie_bhat, susie_bhat_add_z, susie_rss, susie_rss_add_z) * (score_susie, plot_susie), (finemap, finemap_add_z) * (score_finemap, plot_finemap))
  ...
  output: output/r_compare_add_z_lambda
