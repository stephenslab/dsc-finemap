...
DSC:
  ...
  run:
    default: data * sim_gaussian * get_sumstats * ((susie_bhat,susie_z) * (score_susie, plot_susie), finemap * (score_finemap, plot_finemap))
    null: data * sim_gaussian_null * get_sumstats * ((susie_bhat, susie_z) * (score_susie, plot_susie), finemap * (score_finemap, plot_finemap))
    ...
    dap: data * sim_gaussian * get_sumstats * (dap_z * (score_dap, plot_dap))
    dap_null: data * sim_gaussian_null * get_sumstats * (dap_z * (score_dap, plot_dap))
  exec_path: code
  global:
